...
const Process4 = () => {
  return <div className="wrapper bg-soft-primary">
      <div className="container py-14 pt-md-16 pt-lg-0 pb-md-16">
        <div className="row text-center" style={animation({
        name: 'slideInUp',
        delay: '0ms'
      })}>
          <div className="col-lg-10 mx-auto">
            <div className="mt-lg-n20 mt-xl-n22 position-relative">
              ...
              <div className="shape rounded-circle bg-line primary rellax w-18 h-18" style={{
              zIndex: 0,
              bottom: '2rem',
              right: '-3rem'
            }} />

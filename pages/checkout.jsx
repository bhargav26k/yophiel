...
import { Checkbox, Input, Select } from 'components/elements/checkout-form'; // -------- data -------- //
            ...
            <div className="row gx-md-8 gx-xl-12 gy-12">
              ...
              <div className="col-lg-8">
                <div className="alert alert-blue alert-icon mb-6" role="alert">
                  ...
                  <a href="#" data-bs-toggle="modal" data-bs-dismiss="modal" className="alert-link hover" data-bs-target="#modal-signin">
                    Sign in
                  </a>{' '}
                ...
                <form className="needs-validation">
                  <div className="row g-3">
                    ...
                    <div className="col-md-5">
                      <Select required id="country" label="Country" options={[{
                      title: 'United States',
                      value: 'usa'
                    }]} />
                    </div>
                    ...
                    <div className="col-md-4">
                      <Select required id="state" label="State" options={[{
                      title: 'California',
                      value: 'california'
                    }]} />
                    </div>
                    ...
                    <div className="col-xl-8">
                      <div className="row gy-3 gx-3">
                        <div className="col-md-12">
                          <Input type="text" id="cc-number" label="Credit card number" placeholder="Credit card number" />
                        </div>
                        ...
                        <div className="col-md-3">
                          <Input type="text" id="cc-expiration" placeholder="Expiration" label="Expiration date required" />
                        </div>
              ...
              <div className="col-lg-4">
                ...
                <div className="shopping-cart mb-7">
                  {orderProducts.map(item => <ProductCard2 {...item} key={item.id} />)}
                </div>
                ...
                <div className="mb-5">
                  ...
                  <div className="form-check">
                    <input required id="express" type="radio" defaultChecked name="shippingMethod" className="form-check-input" />

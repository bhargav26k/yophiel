...
const ProjectDetails = () => {
  ...
  return <Fragment>
      ...
      <main className="content-wrapper">
        <section className="wrapper image-wrapper bg-image bg-cover bg-height" style={{
        backgroundImage: 'url(/img/photos/pp23.jpg)'
      }} />
        ...
        <section className="wrapper bg-light wrapper-border">
          <div className="container py-14 py-md-16">
            ...
            <ProjectDetailsContent title="Memphis Brand Design" titleClass="display-4 mb-4" contentRowClass="row gx-0 mb-12" />
              ...
              fullUrl
                  ...
                  <figure className="hover-scale rounded cursor-dark">
                    <a href={fullUrl} data-glightbox data-gallery="project-4">
                      <Image width={width} height={height} src={url} alt="demo" style={{
                    width: '100%',
                    height: 'auto'
                  }} />
                    </a>

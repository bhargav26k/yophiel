              ...
              <Element name="terms-conditions" className="wrapper pt-16">
                <div className="card">
                  <div className="card-body p-10">
                    ...
                    <List data={['Aenean eu leo quam ornare curabitur blandit tempus.', 'Nullam quis risus eget urna mollis ornare donec elit.', 'Etiam porta sem malesuada magna mollis euismod.', 'Fermentum massa vivamus faucibus amet euismod.']} />
                  </div>
                </div>
              </Element>
...
const List = ({
  ...
  return <ul className="icon-list bullet-bg bullet-soft-primary mb-0">
      {data.map(item => {
      return <li key={item}>
            <span>

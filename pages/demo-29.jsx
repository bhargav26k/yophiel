...
const Demo29 = () => {
  return <Fragment>
      ...
      <header className="wrapper">
        <Navbar info language navClassName="navbar navbar-expand-lg center-nav transparent position-absolute navbar-light caret-none" />
      </header>
      ...
      <main className="content-wrapper">
        ...
        backgroundImage: 'url(/img/photos/bg23.png)'
          ...
          <div className="container py-14 pt-md-16 pt-lg-0 pb-md-17 position-relative" style={{
          zIndex: 2
        }}>
            <div className="row">

...
import data from 'data/pricing-page'; // -------- carousel breakpoint obj -------- //
          ...
          <div className="container pb-14 pb-md-16">
            ...
            <div className="row">
              ...
              <div className="row mb-14 mb-md-18">
                {data.accordionList.map((items, i) => <div className="col-lg-6 mb-0" key={i}>
                    <div className="accordion-wrapper" id="accordion">
                      {items.map(item => <Accordion key={item.no} {...item} />)}
                    </div>
                  </div>)}
              </div>
            </div>
            ...
            <div className="position-relative">
              <div className="shape rounded-circle bg-soft-yellow rellax w-16 h-16" style={{
              bottom: '0.5rem',
              right: '-1.7rem',
              transform: 'translate(0px, 2px, 0px)'
            }} />

              <div className="shape bg-dot primary rellax w-16 h-16" style={{
              top: '-1rem',
              left: '-1.7rem',
              transform: 'translate(0px, -31px, 0px)'
            }} />
              ...
              <div className="swiper-container dots-closer mb-6">
                <Carousel grabCursor spaceBetween={0} navigation={false} breakpoints={carouselBreakpoints}>
                  {data.testimonialList.map((item, i) => <div className="item-inner" key={i}>

...
import CartListItem from 'components/reuseable/CartListItem'; // -------- data -------- //
                  ...
                  <table className="table text-center shopping-cart">
                    <thead>
                      <tr>
                        ...
                        return <th className={firstChild ? 'ps-0 w-25' : ''} key={id}>
                    ...
                    <tbody>
                      {cartList.map(item => <CartListItem key={item.id} {...item} />)}
                    </tbody>
                  </table>
                </div>

...
import CountUp from 'react-countup'; // -------- custom component -------- //
...
const Demo34 = () => {
  ...
  useTooltip(); // used for demo filtering and masionry layout
  ...
  return <Fragment>
        ...
        <div className="container">
          <div className="alert-inner d-flex justify-content-center align-items-center p-0">
            <p className="mb-0">
              ...
              <a href="https://sandbox.elemisthemes.com" className="link-white hover d-inline-flex align-items-center" target="_blank">
      ...
      <header className="wrapper bg-soft-primary">
        <Navbar logoAlt="logo-purple" button={<a href="https://1.envato.market/Ea4VxK" className="btn btn-primary rounded-pill" target="_blank" rel="noreferrer">
              Purchase Now
            </a>} />
      </header>
      ...
      <main className="content-wrapper">
                      ...
                      <div className="row gx-md-8 gx-xl-12 d-flex align-items-center">
                          ...
                          <div className="row gx-4 gx-md-7">
                            <div className="col-6">
                              <figure className="itooltip itooltip-yellow mt-9" title="Click to see the demo">
                                <a href={link} target="_blank" rel="noreferrer">
                                  <img alt="" className="shadow-lg rounded-top" src={`/img/demos/${images[0]}.jpg`} srcSet={`/img/demos/${images[0]}@2x.jpg 2x`} />
                                </a>
                              </figure>
                            </div>
                            ...
                            <div className="col-6">
                              <figure className="itooltip itooltip-yellow" title="Click to see the demo">
                                <a href={link} target="_blank" rel="noreferrer">
                                  <img alt="" className="shadow-lg rounded-bottom" src={`/img/demos/${images[1]}.jpg`} srcSet={`/img/demos/${images[1]}@2x.jpg 2x`} />
                                </a>
                              </figure>
                            </div>
                          </div>
                        ...
                        <div className="col-lg-5 d-none d-lg-block py-3">
                          ...
                          <ul className={`icon-list bullet-${color} row ms-0 gy-2`}>
                            {features.map(item => <li className="col-md-6" key={item}>
                                <i className="uil uil-check" />
                                <span>{item}</span>
                              </li>)}
                          </ul>

                          <a href={link} target="_blank" rel="noreferrer" className={`btn btn-sm btn-${color} rounded-pill mt-1`}>
                            See Demo
                          </a>
                        </div>
                      </div>
          ...
          <div className="container pb-11 pb-md-14">
            <div className="row gx-lg-8 gx-xl-0 gy-10 align-items-center mb-14 mb-md-16">
              <div className="col-lg-6 position-relative">
                <div className="shape rounded bg-soft-primary rellax d-block" style={{
                zIndex: 0,
                top: '50%',
                left: '50%',
                width: '50%',
                ...
                <div className="row gx-md-5 gy-5 position-relative">
                  <div className="col-6">
                    <img alt="" src="/img/demos/fe1.jpg" srcSet="/img/demos/fe1@2x.jpg 2x" className="img-fluid rounded shadow-lg mb-5" />
                    <img alt="" src="/img/demos/fe2.jpg" srcSet="/img/demos/fe2@2x.jpg 2x" className="img-fluid rounded shadow-lg d-flex col-10 ms-auto" />
                  </div>

                  <div className="col-6">
                    <img alt="" src="/img/demos/fe3.jpg" srcSet="/img/demos/fe3@2x.jpg 2x" className="img-fluid rounded shadow-lg my-5" />
                    <img alt="" src="/img/demos/fe4.jpg" srcSet="/img/demos/fe4@2x.jpg 2x" className="img-fluid rounded shadow-lg d-flex col-10" />
                  </div>
                </div>
              </div>
            ...
            <div className="row gx-lg-8 gx-xl-0 gy-10 align-items-center mb-16 mb-md-22">
              <div className="col-lg-6 offset-xl-1 position-relative order-lg-2">
                ...
                <div className="row gx-md-5 gy-5 position-relative">
                  <div className="col-5">
                    <img alt="" src="/img/demos/fe5.jpg" srcSet="/img/demos/fe5@2x.jpg 2x" className="img-fluid rounded shadow-lg my-5 d-flex ms-auto" />
                    <img alt="" src="/img/demos/fe6.jpg" srcSet="/img/demos/fe6@2x.jpg 2x" className="img-fluid rounded shadow-lg d-flex col-10 ms-auto" />
                  </div>

                  <div className="col-7">
                    <img alt="" src="/img/demos/fe7.jpg" srcSet="/img/demos/fe7@2x.jpg 2x" className="img-fluid rounded shadow-lg mb-5" />
                    <img alt="" src="/img/demos/fe8.jpg" srcSet="/img/demos/fe8@2x.jpg 2x" className="img-fluid rounded shadow-lg d-flex col-11" />
                  </div>
                </div>
              </div>
          ...
          <div className="container pb-14 pb-md-16">
            <div className="row gx-0 mb-14 mb-md-16">
              <div className="col-9 col-sm-10 col-lg-9 mx-auto mt-n15 mt-md-n23">
                <img alt="" src="/img/demos/de1.jpg" srcSet="/img/demos/de1@2x.jpg 2x" className="img-fluid mx-auto rounded shadow-lg" />
                <img alt="" src="/img/demos/de2.jpg" srcSet="/img/demos/de2@2x.jpg 2x" className="position-absolute rounded shadow-lg" style={{
                top: '25%',
                right: '-12%',
                maxWidth: '30%',
                height: 'auto'
              }} />
                <img alt="" src="/img/demos/de3.jpg" srcSet="/img/demos/de3@2x.jpg 2x" className="position-absolute rounded shadow-lg" style={{
                top: '15%',
                left: '-15%',
                maxWidth: '30%',
                height: 'auto'
              }} />
                <img alt="" src="/img/demos/de4.jpg" srcSet="/img/demos/de4@2x.jpg 2x" className="position-absolute rounded shadow-lg" style={{
                bottom: '15%',
                left: '-13%',
                maxWidth: '30%',
                height: 'auto'
              ...
              <div className="isotope-filter filter mb-10 text-start text-md-center">
                ...
                <ul>
                  ...
                  value
                      ...
                      <a onClick={handleFilterKeyChange(value)} className={filterKey === value ? 'filter-item active' : 'filter-item'}>
                        {title}
                      </a>
                    </li>)}
                </ul>
        ...
        <section className="wrapper bg-light">
          <div className="container pt-lg-20 pb-18 pb-xxl-20 position-relative">
            <img alt="" data-cue="fadeIn" src="/img/demos/devices.png" srcSet="/img/demos/devices@2x.png 2x" className="position-lg-absolute col-12 col-lg-12 mt-xxl-n3 mb-3 mb-md-10 mb-lg-0" style={{
            top: 0,
            left: '-23%'
          }} />
            ...
            <div className="row gx-lg-8 gx-xl-12 mt-lg-n16 mt-xl-n12 mt-xxl-0 align-items-xxl-center">
              <div className="col-md-10 offset-md-1 col-lg-6 offset-lg-6 text-center text-lg-start">
                <div className="ps-xl-1 ps-xxl-5 pe-xxl-10">
                  ...
                  <img src="/img/demos/qrcode.jpg" srcSet="/img/demos/qrcode@2x.jpg 2x" className="shadow-lg rounded" alt="" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container pt-xl-10 text-center">
            <div className="row">
              <div className="col-md-10 col-lg-9 col-xl-8 col-xxl-7 mx-auto">
                ...
                <a href="https://1.envato.market/Ea4VxK" target="_blank" className="btn btn-lg btn-primary rounded-pill mb-10" rel="noreferrer">
                  Buy Sandbox
                </a>
              </div>
            </div>

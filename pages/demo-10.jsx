      ...
      <main className="content-wrapper">
        ...
        <section className="wrapper bg-light">
          <div className="container py-14 py-md-17">
            <Services6 rowClassNames="mb-14 mb-md-17" colOne={<Tiles8 hiddenShape />} title="We make spending stress free so you have the perfect control." description="Etiam porta sem malesuada magna mollis euismod. Donec ullamcorper nulla non metus auctor
              fringilla. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Fusce dapibus,
              tellus ac cursus commodo." />

            <Services6 colOne={<Tiles9 hiddenShape />} title="We bring solutions to manage your finance the way works best." description="Etiam porta sem malesuada magna mollis euismod. Donec ullamcorper nulla non metus auctor
              fringilla. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Fusce dapibus,
              tellus ac cursus commodo." />
          </div>
        </section>

...
const projectList = [{
  ...
  cardStyle: {
    transform: 'translate(0px, -23px, 0px)'
  },
  detailsStyle: {
    right: '10%',
    bottom: '25%'
  ...
  cardStyle: {
    transform: 'translate(0px, 80px, 0px)'
  },
  detailsStyle: {
    left: '18%',
    bottom: '25%'
  ...
  description: `Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.`,
  cardStyle: {
    transform: 'translate(0px, 32px, 0px)'
  },
  detailsStyle: {
    right: '3%',
    bottom: '25%'
  ...
  description: `Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.`,
  cardStyle: {
    transform: 'translate(0px, 9px, 0px)'
  },
  detailsStyle: {
    left: '18%',
    bottom: '25%'
  ...
  description: `Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.`,
  cardStyle: {
    transform: 'translate(0px, 14px, 0px)'
  },
  detailsStyle: {
    right: '15%',
    bottom: '25%'
        ...
        <section className="wrapper bg-light">
          <div className="container pt-9 pt-md-11 pb-14 pb-md-16">
            ...
            <div className="projects-overflow mt-md-10 mb-10 mb-lg-15">
              {projectList.map(item => <ProjectCard2 {...item} key={item.id} />)}
            </div>
